...
<p style="color:black;">Your purchase has been completed successfully.</p>
<hr>
<p class="mb-0" style="color:black;">Thank you for shopping with us.</p>

        <a href="<%= request.getContextPath() %>/products" class="btn btn-primary mt-3">Back to Home</a>
    </div>
</div>
